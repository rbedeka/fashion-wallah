e,
  slides_to_show,
  slides_to_show_// HorizontalCarousel.js
...
const HorizontalCarousel = ({
  ...
  const settings = {
    ...
    arrows,
    dots,
    slidesToShow: slides_to_show, // Set the number of items to show at a time
    slidesToScroll: 1,
    responsive: [
      {
        breakpoint: 1024, // Adjust breakpoints as needed
        settings: {
          slidesToShow: slides_to_show_resp[0],
          slidesToScroll: 1,
        },
      },
      {
        breakpoint: 768,
        settings: {
          slidesToShow: slides_to_show_resp[1],
          slidesToScroll: 1,
        },
      },
      {
        breakpoint: 480,
        settings: {
          slidesToShow: slides_to_show_resp[2],
          slidesToScroll: 1,
        },
      },
    ],
